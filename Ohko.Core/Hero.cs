...
{
    protected Hero(World world)
    {
        Body = world.CreateBody(Vector2.Zero.Into(), 0f, BodyType.Dynamic);
    ...
    private static Vector2 CenterOffset(
        Rectangle a,
        Rectangle b)
    {
        // Center of A
    ...
    private void Apply(List<ControlPad.ButtonPosition> result)
    {
    ...
    private List<HitBoxConfig> GetHitBoxes()
    {
